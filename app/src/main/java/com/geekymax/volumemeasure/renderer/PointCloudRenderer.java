 ...
 */
package com.geekymax.volumemeasure.renderer;

import android.content.Context;
import android.opengl.GLES20;
import android.opengl.Matrix;

import com.geekymax.volumemeasure.util.ShaderUtil;
...
public class PointCloudRenderer {
     ...
     *
     * @param pointsBuffer 点的floatBuffer
     * @param timestamp    标志该点云的时间戳
     */
    public void update(FloatBuffer pointsBuffer, long timestamp) {
        ...
        numPoints = pointsBuffer.remaining() / FLOATS_PER_POINT;
        ...
        GLES20.glBufferSubData(
                GLES20.GL_ARRAY_BUFFER, 0, numPoints * BYTES_PER_POINT, pointsBuffer);
        GLES20.glBindBuffer(GLES20.GL_ARRAY_BUFFER, 0);
